...
export function cfgClient(this: LoginComponent, reset: boolean, config: IOAuth2Config, newCfg: IOAuth2Config, credentials: customParametersType) {
    ...
    if (!newCfg.parameters.client_secret) delete newCfg.parameters.client_secret;
